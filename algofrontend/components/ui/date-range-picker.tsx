...
const PRESETS: Preset[] = [
  ...
  { name: 'expiredMaturity', label: 'Expired Maturity' },
  { name: 'residualMaturity', label: 'Residual Maturity' },
  { name: 'bondMaturity', label: 'Bond Maturity' },
]
